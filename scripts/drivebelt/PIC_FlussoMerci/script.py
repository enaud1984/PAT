...
schema = [
    {
        ...
        "MerciPericolose#merce_pericolosa_flg": "",
        "Origine#origine": "",
        "Destinazione#destinazione": "",
        "TipologiaTrasporto#tipologia_trasporti": "",
        "TipologiaMerce#categoria_merce": "",
        "Tonnellate#peso_merce(double)": None,
        "Progressivo#progressivo(int)": None,
...
class ScriptProcess:
    def process(self, req):
        ...
        logging.info(f"PicFlussoMerci - len(list_) - {len(list_)}")
        logging.info(f"PicFlussoMerci - list_ - {list_}")
