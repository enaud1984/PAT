...
schema = {
    ...
    "viaggio": {
        "listaTappe": [{
                "id as id(int)": None,
                "targa as targa": None,
                "dataOperazione as dataOperazione": None,
                "posizioneInizioTappa as posizioneInizioTappa": None,
                "posizioneFineTappa as posizioneFineTappa": None,
                "posizione as posizione": None,
                "statoTappa as statoTappa": None,
                "utenteApp as utenteApp": None,
                "dataDaOperatore as dataDaOperatore": None,
                "operatoreTappa as operatoreTappa": None
        }]
    }
}
